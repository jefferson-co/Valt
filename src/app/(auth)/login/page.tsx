...
function LeftPanel({ headline, sub }: { headline: string; sub: string }) {
  return (
    <div className="relative hidden h-screen flex-col md:flex" style={{ width: "55%" }}>
      ...
      {/* Geometric panes — angular faceted look */}
      <div
      ...
      {/* Edge-highlight lines at pane intersections */}
      <div
...
function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <LeftPanel
        headline={"Your Links,\nYour Identity."}
        sub="A fully customizable link-in-bio with real analytics, theme control, and a space to showcase who you are."
      />
      ...
      >
        ...
        <div style={{ maxWidth: 400, width: "100%" }}>
          ...
          <p className="mb-7 text-sm" style={{ color: "var(--text-2)" }}>
            Log in to manage your Valt profile.
          </p>
            ...
            <div className="flex items-center justify-between pt-0.5">
              <label className="flex cursor-pointer items-center gap-2 text-sm" style={{ color: "var(--text-2)" }}>
                <input
                  ...
                  style={{ width: 15, height: 15, accentColor: "var(--accent)", cursor: "pointer", borderRadius: 4 }}
                />
                Remember Me
              </label>
              <a
